...
def get_keyboard(width_keyboard , height_keyboard, offset_keyboard):
    ...
    row = [80,180,280,380,480,580]
    column = [100,200 ,300, 400, 500, 600 ,700, 800, 900,1000]
    ...
    key_points.append([preds[0], (100-10, 620), (100-40, 550), (100+200, 700)])
    key_points.append([preds[1], (200+130, 620), (200+100, 550), (200+340, 700)])
    key_points.append([preds[2], (300+270, 620), (300+240, 550.0), (300+480, 700)])
    key_points.append([preds[3], (400+410, 620), (400 +380, 550.0), (400 + 620, 700)])
